    ...
    <header className="fixed top-4 left-1/2 z-30 -translate-x-1/2 w-[90%] max-w-2xl">
      <div className="flex items-center justify-around rounded-xl bg-white px-4 py-2 shadow-lg border border-gray-200">
        ...
        <div className="sm:hidden ml-auto relative">
          <button
            className="px-3 py-2 rounded-lg bg-gray-100 text-md font-semibold text-gray-800 shadow-sm hover:bg-gray-200 transition"
          ...
          {/* תפריט נפתח במובייל */}
          {isOpen && (
            <div dir="rtl" className="text-center fixed top-16 right-0 w-40 bg-white border border-gray-300 rounded-xl shadow-xl py-3 px-4 space-y-2 z-50">
              <Link
                href="#gallery"
